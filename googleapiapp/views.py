...
def route(request):
	...
	return render(request, 'googleapiapp/route.html', context)
...
def map(request):
	...
	if lat_a and lat_b and lat_c and lat_d:
		...
		# return render('')
		# return render(request, 'googleapiapp/route.html')
		return redirect(reverse('googleapiapp:route'))
	...
	return render(request, 'googleapiapp/map.html', context)    